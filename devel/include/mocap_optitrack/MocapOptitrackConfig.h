...
namespace mocap_optitrack
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(MocapOptitrackConfig &config, const MocapOptitrackConfig &max, const MocapOptitrackConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const MocapOptitrackConfig &config1, const MocapOptitrackConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, MocapOptitrackConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const MocapOptitrackConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, MocapOptitrackConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const MocapOptitrackConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const MocapOptitrackConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, MocapOptitrackConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
